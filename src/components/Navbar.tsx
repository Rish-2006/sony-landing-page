...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={cn(
        "fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 md:px-12 py-4",
        "backdrop-blur-md border-b border-white/5 transition-all duration-300",
        !isScrolled && "border-transparent backdrop-blur-none"
      )}
    >
      ...
      <div>
        <button className="group relative px-5 py-2 rounded-full overflow-hidden font-medium text-sm">
          ...
          <div className="absolute inset-0 rounded-full p-[1px] bg-gradient-to-r from-sony-blue/50 to-sony-cyan/50 -z-10 group-hover:from-sony-blue group-hover:to-sony-cyan transition-all duration-300" />
